            ...
            title: Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.email_rounded, color: Color(0xFF42A5F5), size: 22), // Bleu
                ),
                SizedBox(width: 12),
                Text(
                  'Préférences email',
  ...
  return Row(
    children: [
      ...
      Switch(
        value: value,
        onChanged: onChanged,
        activeColor: Color(0xFF42A5F5), // Bleu
        activeTrackColor: Color(0xFF42A5F5).withOpacity(0.3),
      ),
    ],
  );
}
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(10),
              border: Border.all(color: Color(0xFFEC407A).withOpacity(0.2)),
            ),
            child: Icon(Icons.lock_rounded, color: Color(0xFFEC407A), size: 22), // Rose
          ),
          SizedBox(width: 12),
          Text(
      ...
      title: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.info_rounded, color: Color(0xFFEC407A), size: 22), // Rose
          ),
          SizedBox(width: 12),
          Text(
            'À propos',
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text('Version', style: TextStyle(fontSize: 12, color: Color(0xFF666666))),
                      Text('1.0.0', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600))
                    ]
                  ),
                  SizedBox(height: 4),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Dernière mise à jour', style: TextStyle(fontSize: 12, color: Color(0xFF666666))),
                      Text('2024', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600))
                    ]
                  ),
                  SizedBox(height: 4),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Développeur', style: TextStyle(fontSize: 12, color: Color(0xFF666666))),
                      Text('Eternal Escape Team', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600))
                    ]
                  ),
                ],
              ),
