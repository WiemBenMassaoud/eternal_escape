...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_rounded, color: Color(0xFFEC407A)), // Rose
  ...
  Widget _buildLoading() {
    return Center(
      child: CircularProgressIndicator(color: Color(0xFFEC407A)), // Rose
    );
  }
                ...
                children: [
                  Container(
                    ...
                    child: Icon(Icons.email_rounded,
                        color: Color(0xFF42A5F5), size: 22), // Bleu
                  ),
                  SizedBox(width: 12),
                  Text(
                    'Préférences email',
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(10),
                border:
                    Border.all(color: Color(0xFFEC407A).withOpacity(0.2)),
              ),
              child: Icon(Icons.lock_rounded,
                  color: Color(0xFFEC407A), size: 22), // Rose
            ),
            SizedBox(width: 12),
            Text(
              'Changer le mot de passe',
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(icon, color: Color(0xFFEC407A), size: 24), // Rose
                ),
                SizedBox(width: AppTheme.marginLG),
                Expanded(
                  child: Column(
      ...
      child: ExpansionTile(
        ...
        leading: Container(
          ...
          child: Icon(Icons.question_mark_rounded,
              color: Color(0xFFEC407A), size: 20), // Rose
        ),
        title: Text(
          question,
          style: TextStyle(
