...
class _NotificationsScreenState extends State<NotificationsScreen> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> notifications = [
    ...
    },
    {
      ...
      'color': Color(0xFF06D6A0), // Vert (pour varier)
      'read': true,
    },
  ];
        ...
        leading: Container(
          ...
          child: Material(
            ...
            child: InkWell(
              ...
              child: Icon(Icons.arrow_back_ios_new_rounded, color: Color(0xFFEC407A), size: 20), // Rose
            ),
          ),
        ),
        title: Text(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [Color(0xFFEC407A).withOpacity(0.1), Color(0xFFF06292).withOpacity(0.1)], // Dégradé rose clair
                          ),
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(color: Color(0xFFEC407A).withOpacity(0.2), width: 1.5),
                        ),
                        child: TextButton.icon(
                          onPressed: _markAllAsRead,
                          icon: Icon(Icons.done_all_rounded, size: 18, color: Color(0xFFEC407A)), // Rose
                          label: Text(
                            'Tout marquer',
                            style: TextStyle(
                              color: Color(0xFFEC407A), // Rose
