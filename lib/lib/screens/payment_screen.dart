...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  nbAdults: widget.reservation.nbAdultes,  // ✅ Ajouter
  nbChildren3to17: widget.reservation.nbEnfants3a17,  // ✅ Ajouter
  nbChildrenUnder3: widget.reservation.nbEnfantsMoins3,  // ✅ Ajouter
),
                    ...
                    // Formulaires de paiement selon la méthode
                    AnimatedSwitcher(
  ...
  void _processPayment() async {
    // Valider le formulaire si ce n'est pas un paiement en espèces
...
// Formatter pour la date d'expiration (format MM/AA)
