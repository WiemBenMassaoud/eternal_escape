  ...
  void _showSnackbar(String message, {bool isError = false}) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError ? const Color(0xFFE53935) : const Color(0xFF4CAF50), // Rouge/Vert
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(0xFF1A237E), // Bleu foncé élégant
              Color(0xFF283593),
              Color(0xFF303F9F),
              Color(0xFF3949AB),
            ],
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                ...
                                BoxShadow(
                                  color: Color(0xFF4CAF50).withOpacity(0.3), // Vert subtil
                                  blurRadius: 15,
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Icon(Icons.login_rounded, size: 26, color: Color(0xFF4CAF50)), // Vert élégant
